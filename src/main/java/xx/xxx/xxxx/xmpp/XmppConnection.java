...
import xx.xxx.xxxx.crypto.XmppDomainVerifier;
import xx.xxx.xxxx.crypto.sasl.Anonymous;
import xx.xxx.xxxx.crypto.sasl.DigestMd5;
import xx.xxx.xxxx.crypto.sasl.External;
import xx.xxx.xxxx.crypto.sasl.Plain;
import xx.xxx.xxxx.crypto.sasl.SaslMechanism;
import xx.xxx.xxxx.crypto.sasl.ScramSha1;
import xx.xxx.xxxx.crypto.sasl.ScramSha256;
...
import xx.xxx.xxxx.utils.DNSHelper;
import xx.xxx.xxxx.utils.SSLSocketHelper;
import xx.xxx.xxxx.utils.SocksSocketFactory;
import xx.xxx.xxxx.xml.Element;
import xx.xxx.xxxx.xml.Tag;
import xx.xxx.xxxx.xml.TagWriter;
import xx.xxx.xxxx.xml.XmlReader;
...
import xx.xxx.xxxx.xmpp.stanzas.AbstractAcknowledgeableStanza;
...
import xx.xxx.xxxx.xmpp.stanzas.csi.ActivePacket;
import xx.xxx.xxxx.xmpp.stanzas.csi.InactivePacket;
import xx.xxx.xxxx.xmpp.stanzas.streammgmt.AckPacket;
import xx.xxx.xxxx.xmpp.stanzas.streammgmt.EnablePacket;
import xx.xxx.xxxx.xmpp.stanzas.streammgmt.RequestPacket;
import xx.xxx.xxxx.xmpp.stanzas.streammgmt.ResumePacket;
...
public class XmppConnection implements Runnable {
	...
	protected synchronized void changeStatus(final Account.State nextStatus) {
		if (Thread.currentThread().isInterrupted()) {
			...
			//ConversationActivity.resetAccount();//reseteando cuenta si no conecta
		}
